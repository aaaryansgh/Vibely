    ...
    <div>
        <div className='min-h-screen flex items-center justify-center bg-black'>
            <form onSubmit={(e)=>e.preventDefault()} className='flex flex-col items-center justify-center backdrop-blur-md bg-white/5 border border-white/20 p-8 rounded-3xl shadow-lg mt-10'>
                ...
                <input type="text" placeholder='someone@example.in' className='bg-white/5 text-white rounded-md p-3 m-2 w-full' ref={email}/>
                <input type="password" placeholder='Xyz123@' className='bg-white/5 text-white rounded-md p-3 m-2 w-full' ref={password}/>
